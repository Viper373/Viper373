...
class LPL_Data:
    def __init__(self):
        ...
        self.headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.64 Safari/537.36 Edg/101.0.1210.53'}
        self.url = 'https://lpl.qq.com/es/data/rank.shtml?iGameId=134&sGameType=7,8'
        self.db = pymysql.connect(
                        host = 'localhost',user = 'root',
                        passwd = 'ShadowZed666',db = 'test',charset = 'utf8')
